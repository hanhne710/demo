...
if (! nv_function_exists('nv_block_slider')) {
    ...
    function nv_block_config_slider($module, $data_block, $lang_block)
    {
		...
		$html .= '	<div class="col-sm-18"><select id="plugin" name="config_plugin" class="w300 form-control">';
		$plugin = array(
			'nivo',
			'jssor',
			'wow',			
    ...
    {
        global $home, $global_config, $site_mods, $module_config, $nv_Cache, $db;
        ...
        if (! empty($list)) {
			...
			$xtpl->assign('IS_HOME', $home ? 'is-home' : '');
