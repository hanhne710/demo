...
{
    global $global_array_shops_cat, $module_name, $pro_config, $module_file, $module_upload, $db, $link, $module_info, $global_config;
    ...
    while (list (
        ...
        $price = nv_get_price($id, $pro_config['money_unit']);
