...
function nv_site_theme($contents, $full = true)
{
    ...
    if (!array_search('og:image', array_column($metatags, 'value'))) {
        $metatags[] = [
            'name' => 'property',
            'value' => 'og:image',
            'content' => NV_MY_DOMAIN . '/uploads/default-image-home.jpg'
        ];
        $metatags[] = [
            'name' => 'property',
            'value' => 'og:image:alt',
            'content' => $global_config['site_name']
        ];
    }
