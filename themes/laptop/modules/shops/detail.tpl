...
<div class="product-detail <!-- BEGIN: popupid -->prodetail-popup<!-- END: popupid -->" itemtype="http://schema.org/Product" itemscope>
    ...
    <h1 class="bk-product-name" itemprop="name">{TITLE}</h1>
    <div class="row">
        <div class="col-xs-24 col-md-18">
                ...
                <div class="row">
                    <div class="col-xs-24 col-sm-11 col-md-11 text-center">
                        ...
                        <div class="product-one-image mb-2">
                            <img class="bk-product-image" itemprop="image" src="{IMAGE.file}" alt="{DATA.homeimgalt}" id="product-image-one-view">
                        </div>
                                ...
                                <div class="gallery-view-inner owl-carousel" id="product-image-gallery-view">
                                    ...
                                    <div class="item" data-item="{IMAGE_STT}">
                                        <div class="item-inner">
                                            <img class="bk-product-image " itemprop="image" src="{IMAGE.file}" alt="{DATA.homeimgalt}" data-zoom-image="{IMAGE.file}">
                                        </div>
                                    </div>
                                    <!-- END: loop -->
                                </div>
                    ...
                    <div class="col-xs-24 col-sm-13 col-md-13">
                        <div class="box-price">
                            ...
                            <div class="info-price">
                                <!-- BEGIN: discounts -->
                                <span class="money bk-product-price">{PRICE.sale_format}{PRICE.unit}</span> <del class="discounts_money">{PRICE.price_format}{PRICE.unit}</del>
                                <!-- END: discounts -->
                                <!-- BEGIN: no_discounts -->
                                <span class="money bk-product-price">{PRICE.price_format}{PRICE.unit}</span>
                                <!-- END: no_discounts -->
                            </div>
                            <!-- END: price -->
                            <!-- BEGIN: product_weight -->
                            <div class="info-weight">{LANG.weights}: <strong>{PRODUCT_WEIGHT}</strong>&nbsp<span>{WEIGHT_UNIT}</span></div>
                            <!-- END: product_weight -->
                            <!-- BEGIN: contact -->
                            <div class="info-priceno"><span class="money bk-check-out-of-stock">{LANG.price_contact}</span></div>
                            <!-- END: contact -->
                        </div>
                        ...
                        <div class="order-number">
                            <div class="row">
                                ...
                                <div class="col-xs-16 col-sm-19">
                                    <input  type="number" name="num" value="1" min="1" id="pnum" class="pull-left form-control bk-product-qty" style="width: 100px; margin-right: 5px">
                        ...
                        <!-- END BK BUTTON -->
                        <!-- BEGIN: product_empty -->
                        <div class="text-out-of-stock">{LANG.product_empty}</div>
                        <!-- END: product_empty -->
                        <!-- BEGIN: gift -->
                        <fieldset class="free-gifts">
                            <legend>
                                <em class="fa fa-gift fa-3x">&nbsp;</em> Quà tặng
                            </legend>
                            {gift_content}
                        </fieldset>
                        <!-- END: gift -->
                        <!-- BEGIN: group -->
                        <div class="well pro-group-lists hide d-none">
                        ...
                        <div class="box-buttons">
                            <a href="tel:0796.889.883" class="btn-buy-phone">
                                <span>MUA NGAY</span>
                                <br>
                                <small>(qua điện thoại)</small>
                            </a>
                            <a href="https://m.me/vuta.vn" target="_blank" class="btn-buy-zalo">
                                <span>TƯ VẤN MUA HÀNG</span>
                                <br>
                                <small>(qua Messenger)</small>
                            </a>
                        </div>
           ...
           <div id="bodyhtml" class="data_more_less">
                <h3>Thông tin chi tiết</h3>
                <div class="content-bodyhtml data_more_less_inner" data-height="400" data-increase-by="5000">
                ...
                <a href="#" class="action_more more_less_action btn">Xem thêm</a>
                <a href="#" class="action_less more_less_action btn">Thu gọn</a>   
            </div>
            <!-- BEGIN: tabs -->
        ...
        <div class="col-xs-24 col-md-6">
            <div class="box-support">
                <img src="/uploads/customer-service.png" alt="Gọi ngay">
                <span>Gọi ngay <a href="tel:0796.889.883"><strong>0796.889.883</strong></a> để được tư vấn tốt nhất!</span>
            </div>
            [RIGHT]
        </div>
    </div>
