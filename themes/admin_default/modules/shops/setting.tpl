...
<form class="form-inline" action="" method="post">
    ...
    <div class="table-responsive" id="setting_gift_content">
        <table class="table table-striped table-bordered table-hover">
            <caption>Nội dung quà tặng mặc định</caption>
            <colgroup>
                <col class="w500" />
            </colgroup>
            <tbody>
                <tr>
                    <td><strong>Nhập nội dung quà tặng mặc định</strong></td>
                    <td>{edit_gift_default}</td>
                </tr>
            </tbody>
        </table>
    </div>
