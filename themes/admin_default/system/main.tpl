...
<div class="container-fluid nvwrap">
	...
	<header id="header" class="row">
		<div class="logo">
			<a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
				<span class="logo-md">Quản trị <strong>HỆ THỐNG</strong></span>
			</a>
		</div>
				...
				<div class="collapse navbar-collapse" id="menu-horizontal">
					<ul class="nav navbar-nav">
						<li class="hidden-md hidden-sm hidden-xs">
							<a title="{LANG.Home}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}"><em class="fa fa-lg fa-home"></em></a>
						</li>
						<!-- BEGIN: top_menu_loop -->
						<li {TOP_MENU_CLASS}>
	...
	<section id="middle" class="row">
		<aside id="left-menu">
			<div id="bg-left-menu" style="width: 200px;">
	...
	<footer id="footer" class="row">
		<div class="footer-content">
			...
			<div class="footer-vuta">
				<div class="copyright text-right">
					<small>Phát triển và vận hành bởi</small> <strong>CÔNG TY TNHH VUTA VIỆT NAM</strong>
					<br><strong><small>Website:</small></strong> <a href="https://vuta.vn" target="_blank">vuta.vn</a> - <strong><small>Email:</small></strong> <a href="mailto:hi@vuta.vn">hi@vuta.vn</a> - <strong><small>Hotline:</small></strong> <a href="tel:0796889883"><strong>0796.889.883</strong></a>
				</div>
			</div>
		</div>
	</footer>
